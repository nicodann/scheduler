...
storiesOf("Appointment", module)
  ...
  .add("Empty Appointment", () => <Empty onAdd={action("onAdd")}/>)
  .add("Show Appointment", () => <Show student="Lydia Miller-Jones" interviewer={interviewer} onEdit={action("onEdit")} onDelete={action("onDelete")}/>)
